...
const getRandomNumbers = (min = 10, max = 99) => {
...
const checkExampleResult = () => {
    const resultFirst = document.querySelector("#result-0");
    const resultSecond = document.querySelector("#result-1");
    const resultThird = document.querySelector("#result-2");
